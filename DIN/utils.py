...
def create_amazon_electronic_dataset(file, embed_dim=8, maxlen=40):
    ...
    with open('/Users/songlei/Desktop/moji/Recommender-System-with-TF2.0/dataset/dataset.pkl', 'wb') as f:
        pickle.dump(feature_columns, f, pickle.HIGHEST_PROTOCOL)
        pickle.dump(behavior_list, f, pickle.HIGHEST_PROTOCOL)
        pickle.dump((train_X, train_y), f, pickle.HIGHEST_PROTOCOL)
        pickle.dump((val_X, val_y), f, pickle.HIGHEST_PROTOCOL)
        pickle.dump((test_X, test_y), f, pickle.HIGHEST_PROTOCOL)
        f.close()
